	...
	<table width="98%" border="0" cellpadding="2" cellspacing="1"
		...
		<tr>
			<td height="28" background="__PUBLIC__/admin/images/tbg.gif"
				style="padding-left: 10px;"><b>编辑360套餐内容： (加*为必填)</b><a
	...
	<table width="98%" border="0" cellpadding="0" cellspacing="0"
		...
		<tr>
			<td bgcolor="#FFFFFF" width="100%">
				<form action="__URL__/editWithAttachDesc/" method="post"
					name="form1">
				   <input type="hidden" value="{$content.id}" name="id" /> 
				   <input type="hidden" value="{$content.type}" name="type" />
					<div id="_mainsearch">

						<table class="edit-tab" width="100%" style='' id="" border="0"
							cellspacing="0" cellpadding="1">

							<tr>
								<td class="head">*标题：</td>
								<td class="tail" colspan="2"><input type='text' name="title"
									value="{$content.title}" style='width: 60%'></td>
							</tr>
							<tr>
								<td class="head">*描述：</td>
								<td class="tail" colspan="1"><textarea name="content" style="width:60%" rows="8">{$content.content}</textarea></td>
							    <td class="info">文本框内输入图片说明，它会显示<br />在图片上的透明层上面，每一行<br />是一条说明,如：<br />&nbsp;&nbsp;1.廉价<br />&nbsp;&nbsp;2.专业<br />&nbsp;&nbsp;3.耐磨<br /></td>
                            </tr>
							<tr>
								<td class="head">上传图片：</td>
								<td class="tail"><input type="file" name="mp_uploadImg" value=""
									id="mp_uploadImg" style="visibility: hidden" /> <input
									type="hidden" name="mp_uploadImg_ids" value=""
									id="mp_uploadImg_ids" />
									<div id="update_img_list" ></div></td>
							</tr>
