...
<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D6DDD6" align="center">
  <tr>
   ...
   <a href="__URL__/add/type/360cailiao/pid/{$parentContent.id}" class="coolbg" style="display: block;margin:0 auto;width:250px;"> 添加{$parentContent.title}种类内容 </a>
   </td>
  </tr>
...
<div id="_mainsearch">
  ...
  <tbody><tr> 
    <td height="19" colspan="10" background="__PUBLIC__/admin/images/tbg.gif" bgcolor="#E7E7E7">
        ...
        <tbody><tr> 
          <td width="24%" style="padding-left:10px;"><strong><a style="color:#690;text-decoration: underline;" href="__URL__/index/type/360cailiao/">360材料内容列表</a><span class="class-arrow">>></span>{$parentContent.title}种类列表</strong></td>
 ...
 <td> 
    ...
    <tr bgcolor="#ffffff"> 
      <td height="24" colspan="10" >
       ...
       <form name="o-form" method="get" action="__URL__/sublist/pid/{$parentContent.id}">
