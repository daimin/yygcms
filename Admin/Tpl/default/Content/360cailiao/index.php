...
<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D6DDD6" align="center">
  <tr>
   ...
   <a href="__URL__/add/type/360cailiao/" class="coolbg" style="display: block;margin:0 auto;width:100px;"> 添加360材料内容 </a>
   </td>
  </tr>
...
<div id="_mainsearch">
  ...
  <tbody><tr> 
    <td height="19" colspan="10" background="__PUBLIC__/admin/images/tbg.gif" bgcolor="#E7E7E7">
        ...
        <tbody><tr> 
          <td width="24%" style="padding-left:10px;"><strong>360材料内容列表</strong></td>
  ...
  <tr align="center" bgcolor="#009900" height="25" style="color:#fff;font-weight: bold;">
    ...
    <td width="15%" nowrap="nowrap">种类列表</td>
  </tr>
 ...
 <td> 
    ...
    <td>
        <a style="text-decoration: underline;" href="__URL__/sublist/pid/{$item.id}" title="编辑">进入种类列表</a>    
    </td>
    ...
    <tr bgcolor="#ffffff"> 
      <td height="24" colspan="10" >
       ...
       <form name="o-form" method="get" action="__URL__/index/type/360cailiao">
