...
<div style="min-width:780px">
 <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D6DDD6" align="center">
  <tr>
   <td height="28" background="__PUBLIC__/admin/images/tbg.gif" style="padding-left:10px;"><b>添加家装课堂内容： (加*为必填)</b><a class="return-link" href="javascript:window.history.go(-1)">返回列表</a></td>
  </tr>
 ...
 <table width="98%" border="0" cellpadding="0" cellspacing="0" style="margin-top:10px" align="center">
  <tr>
   ...
   <form action="__URL__/addKetang" method="post" name="form1" >
   <div id="_mainsearch">
     ...
     <table class="edit-tab" width="100%" style='' id="" border="0" cellspacing="0" cellpadding="1">
      ...
      <tr >
       <td class="head ">*内容： </td>
       <td class="tail"> <textarea name="content" style='width:70%' rows="20" id="mp_content"></textarea></td>
       
      </tr>
      <tr >
       <td class="head">关联URL： </td>
       <td class="tail"><input type='text' name="relurl" value="" style='width:60%'></td>
