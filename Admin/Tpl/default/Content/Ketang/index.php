...
<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D6DDD6" align="center">
  <tr>
   ...
   <a href="__URL__/addKetang/" class="coolbg" style="display: block;margin:0 auto;width:200px;"> 添加家装课堂内容 </a>
   </td>
  </tr>
...
<div id="_mainsearch">
  ...
  <tbody><tr> 
    <td height="19" colspan="10" background="__PUBLIC__/admin/images/tbg.gif" bgcolor="#E7E7E7">
        ...
        <tbody><tr> 
          <td width="24%" style="padding-left:10px;"><strong>家装课堂内容列表</strong></td>
 ...
 <td> 
    ...
    <td>
        <a style="text-decoration: underline;" href="__URL__/editKetang/cid/{$item.id}" title="编辑">编辑</a>    
    </td>
    ...
    <tr bgcolor="#ffffff"> 
      <td height="24" colspan="10" >
       ...
       <form name="o-form" method="get" action="__URL__/ketang">
	       <select name="o_status">
	           <option value="">所有</option>
	           <option value="1" <?php if(I('o_status') == '1') echo ' selected="selected" ';?>>发布</option>
	           <option value="0" <?php if(I('o_status') == '0') echo ' selected="selected" ';?>>草稿</option>
	       </select>
	       <select name="o_type">
	           <option value="">所有</option>
	           <?php foreach($types as $tk=>$tv){?>
	           <option value="<?php echo $tk?>" <?php if(I('o_type') == $tk) echo ' selected="selected" ';?>><?php echo $tv?></option>
	           <?php }?>
	       </select>
