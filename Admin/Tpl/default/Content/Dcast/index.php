...
<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D6DDD6" align="center">
  <tr>
   ...
   <a href="__URL__/add/type/dcast/" class="coolbg" style="display: block;margin:0 auto;width:100px;"> 添加案例动态内容 </a>
   </td>
  </tr>
...
<div id="_mainsearch">
  ...
  <tbody><tr> 
    <td height="19" colspan="10" background="__PUBLIC__/admin/images/tbg.gif" bgcolor="#E7E7E7">
        ...
        <tbody><tr> 
          <td width="24%" style="padding-left:10px;"><strong>案例动态内容列表</strong></td>
 ...
 <td> 
    ...
    <tr bgcolor="#ffffff"> 
      <td height="24" colspan="10" >
       ...
       <form name="o-form" method="get" action="__URL__/index/type/dcast">
