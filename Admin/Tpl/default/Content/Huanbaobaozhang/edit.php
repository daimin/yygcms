...
<div style="min-width:780px">
 <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D6DDD6" align="center">
  <tr>
   <td height="28" background="__PUBLIC__/admin/images/tbg.gif" style="padding-left:10px;"><b>编辑环保保障内容： (加*为必填)</b>
   </td>
  </tr>
 </table>
 ...
 <table width="98%" border="0" cellpadding="0" cellspacing="0" style="margin-top:10px" align="center">
  <tr>
   ...
   <form action="__URL__/editProject/type/<?php echo I("type")?>" method="post" name="form1" >
