...
<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D6DDD6" align="center">
  <tr>
   ...
   <a href="__URL__/add/type/dnews/" class="coolbg" style="display: block;margin:0 auto;width:200px;"> 添加新闻动态(企业新闻)内容 </a>
   </td>
  </tr>
...
<div id="_mainsearch">
  ...
  <tbody><tr> 
    <td height="19" colspan="10" background="__PUBLIC__/admin/images/tbg.gif" bgcolor="#E7E7E7">
        ...
        <tbody><tr> 
          <td width="24%" style="padding-left:10px;"><strong>新闻动态(企业新闻)内容列表</strong></td>
 ...
 <td> 
    ...
    <tr bgcolor="#ffffff"> 
      <td height="24" colspan="10" >
       ...
       <form name="o-form" method="get" action="__URL__/index/type/dnews">
