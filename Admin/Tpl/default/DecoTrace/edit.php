	...
	<table width="98%" border="0" cellpadding="2" cellspacing="1"
		...
		<tr>
			<td height="28" background="__PUBLIC__/admin/images/tbg.gif"
				style="padding-left: 10px;"><b>编辑家装追踪用户： (加*为必填)</b><a
		...
		<tr>
			<td bgcolor="#FFFFFF" width="100%">
				<form action="__URL__/edit/" method="post"
				   ...
				   <input type="hidden" value="{$homedecoUser.id}" name="id" /> 
					   <div id="_mainsearch">
     
					     <table class="edit-tab" width="100%" style='' id="" border="0" cellspacing="0" cellpadding="1">
					           <tr >
						       <td class="head">*家装用户名： </td>
						       <td class="tail" colspan="2"><input type='text' name="name" value="{$homedecoUser.name}" readonly="readonly" size="40" ></td>
						      </tr>
						      <tr >
						       <td class="head">*新密码： </td>
						       <td class="tail" colspan="2" ><input type='password' name="password" value="" size="40"></td>
						      </tr>
					         <tr >
						       <td class="head">*确认新密码： </td>
						       <td class="tail" colspan="2" ><input type='password' name="repassword" value="" size="40"></td>
						      </tr>
					     </table>
