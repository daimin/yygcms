...
<div style="min-width:780px">
 <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D6DDD6" align="center">
  <tr>
   <td height="28" background="__PUBLIC__/admin/images/tbg.gif" style="padding-left:10px;"><b>添加家装追踪资料： (加*为必填)</b><a class="return-link" href="javascript:window.history.go(-1)">返回列表</a></td>
  </tr>
  ...
  <tr>
   ...
   <div id="_mainsearch">
     ...
     <table class="edit-tab" width="100%" style='' id="" border="0" cellspacing="0" cellpadding="1">
      ...
      <tr >
       <td class="head">日期： </td>
       <td class="tail" colspan="2"><input type='text' name="date" style="border:1px solid #ccc;" value="<?php echo date("Y-m-d")?>" readonly="readonly" style='width:30%'></td>
      </tr>
      <tr>
		<td class="head">描述：</td>
		<td class="tail" colspan="2"><textarea name="caption" style="width:60%" rows="5"></textarea></td>
      </tr>
      <tr >
