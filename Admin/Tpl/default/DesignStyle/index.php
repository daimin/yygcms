...
<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D6DDD6" align="center">
  <tr>
   ...
   <a href="__URL__/add/" class="coolbg" style="display: block;margin:0 auto;width:100px;"> 添加设计风格内容 </a>
   </td>
  </tr>
...
<div id="_mainsearch">
  ...
  <tbody><tr> 
    <td height="19" colspan="10" background="__PUBLIC__/admin/images/tbg.gif" bgcolor="#E7E7E7">
        ...
        <tbody><tr> 
          <td width="24%" style="padding-left:10px;"><strong>设计风格内容列表</strong></td>
  ...
  <tr align="center" bgcolor="#009900" height="25" style="color:#fff;font-weight: bold;">
    ...
    <td width="10%" nowrap="nowrap">设计师</td>
    <td width="10%" nowrap="nowrap">户型</td>
    <td width="10%" nowrap="nowrap">面积</td>
    <td width="10%" nowrap="nowrap">风格</td>
