...
<div style="min-width:780px">
 <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D6DDD6" align="center">
  <tr>
   <td height="28" background="__PUBLIC__/admin/images/tbg.gif" style="padding-left:10px;"><b>添加设计团队内容： (加*为必填)</b><a class="return-link" href="javascript:window.history.go(-1)">返回列表</a></td>
  </tr>
  ...
  <tr>
   ...
   <div id="_mainsearch">
     ...
     <table class="edit-tab" width="100%" style='' id="" border="0" cellspacing="0" cellpadding="1">
      <tr >
       <td class="head">*姓名： </td>
       <td class="tail" colspan="2"><input type='text' name="name" value="" size="80" ></td>
      </tr>
      <tr >
       <td class="head">*职称： </td>
       <td class="tail" colspan="2" ><input type='text' name="rank" value="" size="40"></td>
      </tr>
      <tr>
       <td class="head">*职位： </td>
       <td class="tail" colspan="2" ><input type='text' name="title" value="" size="40"></td>
      </tr>
      <tr>
       <td class="head">*学历： </td>
       <td class="tail" colspan="2" ><input type='text' name="degree" value="" size="40"></td>
      </tr>
       <tr>
       <td class="head">*毕业院校： </td>
       <td class="tail" colspan="2" ><input type='text' name="school" value="" size="80"></td>
      </tr>
      <tr>
       <td class="head">*从业时间： </td>
       <td class="tail" colspan="2" ><input type='text' name="worktime" value="" size="4"> 年</td>
      </tr>
       <tr >
       <td class="head">组： </td>
      ...
      <tr>
       ...
       <td class="tail" colspan="2" >
       <textarea name="motto" rows="5" cols="80"></textarea>
       </td>
      </tr>
      <tr>
       <td class="head">擅长风格： </td>
       <td class="tail" colspan="2" >
       <textarea name="expert" rows="5" cols="80"></textarea>
       </td>
      </tr>
         <tr >
       <td class="head">*照片： </td>
       <td class="tail" colspan="2" ><input type='file' name="photo" value="" size="40"></td>
      </tr> 
      <tr >
