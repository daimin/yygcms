...
<div class="bodyall">
	...
	<div class="content360">
		<div class="pagenav">
		<img src="__PUBLIC__/site/images/cailiaobaozhangicon.jpg" alt="材料保障" width="115" height="32" style="float:left;" border="0" />
...
function box_scroll(dir, idx){
    ...
    var maxLen = (childNodes.length - 8) * 104 - 1 ;
