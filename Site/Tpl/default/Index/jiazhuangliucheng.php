...
<div class="bodyall">
	...
	<div class="content360">
		<div class="pagenav">
		<img src="__PUBLIC__/site/images/jiazhuangliucheng-icon.jpg" alt="家装流程" width="134" height="41" style="float:left;" border="0" />
		<span style="float:right;height:38px;line-height:38px;min-height:38px;color:#6f6f70;"><span>首页</span><span> >> </span><span>家装流程</span></span>
		</div>
		<div class="box-project-container">
		   <img src="__PUBLIC__/site/images/jiazhuangliucheng.jpg" border="none" />
        </div>
	</div>
