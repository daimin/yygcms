...
<div class="bodyall">
	...
	<div class="content360">
		<div class="pagenav">
		<img src="__PUBLIC__/site/images/qiyexinwenicon.png" alt="企业新闻" width="116" height="35" style="float:left;" border="0" />
		<span style="float:right;height:38px;line-height:38px;min-height:38px;color:#6f6f70;"><span>首页</span><span> >> </span><span>看我们</span><span> >> </span><span>企业新闻</span></span>
		</div>
		<div class="box-lookus-news">
		   <table>
			  <volist name="list" id="item">
	             <tr>
	             <td nowrap="nowrap"><a href="__APP__/LookUs/newsdetail/nid/<?php echo $item['id']?>/" target="_blank">{$item.title}</a></td><td><?php echo date("Y-m-d", strtotime($item['createtime']))?></td>
	             </tr>			    
			  </volist>
			  <tr align="right">
