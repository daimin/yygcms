<?php
	...
	$encryption_key		= '7tmwC6IZ';			// Unique 8 to 32 character encryption key
	$notification_email	= 'daiming253685@126.com';	// E-mail for notification of new comments
	$admin_nickname		= 'vagasnail';			// Nickname with admin rights (must be title-cased)
	$admin_password		= 'EufHDguf';			// Password to gain admin rights
