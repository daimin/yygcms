<?php
	...
	$locale = array(
		...
		'zh-cn' => array (
			'comment_form'	=> '在这里写点什么吧...',
			'reply_form'	=> '请在这里输入你要回复的内容...',
			'post_button'	=> '发表评论',
			'del_note'	=> '评论已被删除',
			'cmt_deleted'	=> '评论已删除！',
			'options'	=> '选项',
			...
			'nickname_tip'	=> '昵称或者Twitter @username',
			'nickname'	=> '昵称或者@user',
			'password_tip'	=> '密码（在编辑/删除评论的时候需要',
			'password'	=> '密码',
			'email'		=> 'E-mail',
			'website'	=> '主页',
			'logged_in'	=> '登录成功！',
			'cmt_needed'	=> '您未能输入正确的评论。使用下面的表格。',
			'reply_needed'	=> '您未能输入正确的回复。使用下面的表格。',
			'post_fail'	=> 'Oops！你没有足够的权限。',
			'cmt_tip'	=> 'Accepted HTML: &lt;b&gt;, &lt;u&gt;, &lt;i&gt;, &lt;s&gt;, &lt;pre&gt;, &lt;ul&gt;, &lt;ol&gt;, &lt;li&gt;, &lt;blockquote&gt;, &lt;code&gt; escapes HTML, URLs automagically become links, and [img]URL here[/img] will display an external image.',
			'post_reply'	=> '发表回复',
			'delete'	=> '删除',
			'subscribe_tip'	=> '将通过邮箱通知',
			'subscribe'	=> '订阅',
			'edit_cmt'	=> '编辑评论',
			'save_edit'	=> '保存修改',
			'no_email_warn'	=> '如果不填写邮箱，你将不会收到对你评论的回复通知。',
			'delete_cmt'	=> 'Are you sure you want to delete this comment?',
			'post_cmt'	=> 'Post a Comment',
			'popular_cmts'	=> 'Most Popular',
			'showing_cmts'	=> 'Showing',
